...
interface EditorStore {
  ...
  // GitHub Integration
  githubRepoMode: boolean;
  selectedGitHubRepo: GitHubRepo | null;
  selectedGitHubBranch: GitHubBranch | null;
  ...
  setGitHubRepoMode: (enabled: boolean) => void;
  setSelectedGitHubRepo: (repo: GitHubRepo | null) => void;
  setSelectedGitHubBranch: (branch: GitHubBranch | null) => void;
}
...
export const useEditorStore = create<EditorStore>()(
  persist(
    (set, get) => ({
      ...
      githubRepoMode: false,
      selectedGitHubRepo: null,
      selectedGitHubBranch: null,
      ...
      setGitHubRepoMode: (enabled) => {
        set({ githubRepoMode: enabled });
      },
      
      setSelectedGitHubRepo: (repo) => {
        set({ selectedGitHubRepo: repo });
      },
      
      setSelectedGitHubBranch: (branch) => {
        set({ selectedGitHubBranch: branch });
      },
    }),
    {
      ...
      partialize: (state) => ({
        ...
        githubRepoMode: state.githubRepoMode,
      }),
    }
  )
);